...
var VUnsupportedUnit = /** @class */ (function (_super) {
    ...
    function VUnsupportedUnit() {
        ...
        _this.page = function () {
            ...
            return (0, jsx_runtime_1.jsx)(components_1.Page, __assign({ header: "APP\u65E0\u6CD5\u8FD0\u884C", logout: true }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "m-3 text-danger container" }, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ className: "mb-3 row" }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "col-sm-3 font-weight-bold" }, { children: "\u767B\u5F55\u7528\u6237" })), (0, jsx_runtime_1.jsx)("div", __assign({ className: "col-sm text-body" }, { children: userName }))] })), (0, jsx_runtime_1.jsxs)("div", __assign({ className: "mb-3 row" }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "col-sm-3 font-weight-bold" }, { children: "\u9884\u8BBE\u5C0F\u53F7" })), (0, jsx_runtime_1.jsx)("div", __assign({ className: "col-sm text-body" }, { children: predefinedUnit || (0, jsx_runtime_1.jsx)("small", __assign({ className: "" }, { children: "[\u65E0\u9884\u8BBE\u5C0F\u53F7]" })) }))] })), uqsLoadErrors && uqsLoadErrors.map(function (v) {
                            return (0, jsx_runtime_1.jsxs)("div", __assign({ className: "mb-3 row" }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "col-sm-3 font-weight-bold" }, { children: "App" })), (0, jsx_runtime_1.jsx)("div", __assign({ className: "col-sm text-body" }, { children: v }))] }));
                        }), (0, jsx_runtime_1.jsxs)("div", __assign({ className: "mb-3 row" }, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ className: "col-sm-3 font-weight-bold" }, { children: ["\u5C0F\u53F7", predefinedUnit] })), (0, jsx_runtime_1.jsxs)("div", __assign({ className: "col-sm text-body" }, { children: ["\u9884\u8BBE\u5C0F\u53F7\u5B9A\u4E49\u5728 public/unit.json \u6587\u4EF6\u4E2D\u3002 \u5B9A\u4E49\u4E86\u8FD9\u4E2A\u6587\u4EF6\u7684\u7A0B\u5E8F\uFF0C\u53EA\u80FD\u7531url\u76F4\u63A5\u542F\u52A8\u3002 \u7528\u6237\u7B2C\u4E00\u6B21\u8BBF\u95EEapp\u4E4B\u540E\uFF0C\u4F1A\u7F13\u5B58\u5728localStorage\u91CC\u3002", (0, jsx_runtime_1.jsx)("br", {}), "\u5982\u679C\u8981\u5220\u53BB\u7F13\u5B58\u7684\u9884\u5B9A\u4E49Unit\uFF0Clogout\u7136\u540E\u518Dlogin\u3002"] }))] }))] })) }));
        };
        return _this;
        /*
...
var VUnitSelect = /** @class */ (function (_super) {
    ...
    function VUnitSelect() {
        ...
        _this.renderRow = function (item, index) {
            ...
            return (0, jsx_runtime_1.jsx)(components_1.LMR, __assign({ className: "px-3 py-2", right: 'id: ' + id }, { children: (0, jsx_runtime_1.jsx)("div", { children: nick || name }) }));
        };
        ...
        _this.page = function () {
            return (0, jsx_runtime_1.jsx)(components_1.Page, __assign({ header: "\u9009\u62E9\u5C0F\u53F7", logout: true }, { children: (0, jsx_runtime_1.jsx)("div", { children: "this.controller.appUnits appUnits removed" }) }));
...
var VStartError = /** @class */ (function (_super) {
    ...
    function VStartError() {
        ...
        _this.page = function (_a) {
            var error = _a.error;
            return (0, jsx_runtime_1.jsx)(components_1.Page, __assign({ header: "App start error!" }, { children: (0, jsx_runtime_1.jsx)("pre", { children: typeof error === 'string' ? error : error.message }) }));
        };
        return _this;
    }
