...
var VStart = /** @class */ (function (_super) {
    ...
    VStart.prototype.footer = function () {
        return jsx_runtime_1.jsx("div", __assign({ className: "text-center" }, { children: jsx_runtime_1.jsx(components_1.Ax, __assign({ href: "/login", className: "text-primary" }, { children: "\u5DF2\u6709\u8D26\u53F7\uFF0C\u76F4\u63A5\u767B\u5F55" }), void 0) }), void 0);
    };
