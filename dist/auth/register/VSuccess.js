...
var VForgetSuccess = /** @class */ (function (_super) {
    ...
    VForgetSuccess.prototype.content = function () {
        ...
        return (0, jsx_runtime_1.jsx)("div", __assign({ className: "container w-max-30c" }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "my-5" }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "py-5 text-center text-success" }, { children: "\u6210\u529F\u4FEE\u6539\u5BC6\u7801" })), (0, jsx_runtime_1.jsx)("button", __assign({ className: "btn btn-primary btn-block", onClick: function () { return login(); } }, { children: "\u767B\u5F55\u8D26\u53F7" }))] })) }));
    };
