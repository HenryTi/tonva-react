...
var VRegisterSuccess = /** @class */ (function (_super) {
    ...
    VRegisterSuccess.prototype.content = function () {
        ...
        return jsx_runtime_1.jsx("div", __assign({ className: "container w-max-30c" }, { children: jsx_runtime_1.jsxs("div", __assign({ className: "my-5" }, { children: [jsx_runtime_1.jsxs("div", __assign({ className: "py-5 text-center" }, { children: ["\u8D26\u53F7 ", jsx_runtime_1.jsxs("strong", __assign({ className: "text-primary" }, { children: [account, " "] }), void 0), " \u6CE8\u518C\u6210\u529F\uFF01"] }), void 0), jsx_runtime_1.jsx("button", __assign({ className: "btn btn-success btn-block", type: "button", onClick: function () { return login(undefined); } }, { children: "\u76F4\u63A5\u767B\u5F55" }), void 0)] }), void 0) }), void 0);
    };
...
var VForgetSuccess = /** @class */ (function (_super) {
    ...
    VForgetSuccess.prototype.content = function () {
        ...
        return jsx_runtime_1.jsx("div", __assign({ className: "container w-max-30c" }, { children: jsx_runtime_1.jsxs("div", __assign({ className: "my-5" }, { children: [jsx_runtime_1.jsx("div", __assign({ className: "py-5 text-center text-success" }, { children: "\u6210\u529F\u4FEE\u6539\u5BC6\u7801" }), void 0), jsx_runtime_1.jsx("button", __assign({ className: "btn btn-primary btn-block", onClick: function () { return login(); } }, { children: "\u767B\u5F55\u8D26\u53F7" }), void 0)] }), void 0) }), void 0);
    };
