...
var EditMeInfo = /** @class */ (function (_super) {
    ...
    EditMeInfo.prototype.render = function () {
        return (0, jsx_runtime_1.jsx)(components_1.Page, __assign({ header: "\u4E2A\u4EBA\u4FE1\u606F" }, { children: (0, jsx_runtime_1.jsx)(components_1.Edit, { schema: this.schema, uiSchema: this.uiSchema, data: this.data, onItemChanged: this.onItemChanged }) }));
    };
    return EditMeInfo;
}(React.Component));
