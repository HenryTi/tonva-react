...
var VLogin = /** @class */ (function (_super) {
    ...
    VLogin.prototype.footer = function () {
        return jsx_runtime_1.jsxs("div", __assign({ className: "d-block" }, { children: [jsx_runtime_1.jsx("div", __assign({ className: 'text-center' }, { children: jsx_runtime_1.jsx(components_1.Ax, __assign({ href: "/register", className: "btn btn-link", style: { margin: '0px auto' } }, { children: "\u6CE8\u518C\u8D26\u53F7" }), void 0) }), void 0), components_1.nav.privacyEntry()] }), void 0);
    };
