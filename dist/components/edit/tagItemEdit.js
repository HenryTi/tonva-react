    ...
    function TagItemEdit() {
        ...
        _this.page = (0, mobx_react_1.observer)(function (props) {
            ...
            let content = list?
                ...
                <>no list defined</>;
            */
            return (0, jsx_runtime_1.jsx)(page_1.Page, __assign({ header: '更改' + _this.label, right: right }, { children: (0, jsx_runtime_1.jsx)("div", __assign({ className: "p-3" }, { children: _this.renderInputs() })) }));
        });
        return _this;
    }
