    ...
    ItemEdit.prototype.renderContent = function () {
            ...
            if (templet !== undefined) {
                ...
                switch (uiItem.widget) {
                    ...
                    case 'select':
                        ...
                        divValue = (0, jsx_runtime_1.jsx)("b", { children: list.find(function (v) { return v.value === _this.value; }).title });
                        break;
                    case 'id':
                        divValue = (0, jsx_runtime_1.jsxs)("b", { children: ["no templet for ", name, "=", this.value] });
                        break;
                }
            }
        }
        if (divValue === undefined) {
            switch (type) {
                default:
                    divValue = this.value ?
                        (0, jsx_runtime_1.jsx)("b", { children: this.value })
                        :
                            (0, jsx_runtime_1.jsxs)("small", __assign({ className: "text-muted" }, { children: ["[", labelHide === true ? label : '无', "]"] }));
                    break;
                case 'image':
                    divValue = (0, jsx_runtime_1.jsx)(image_1.Image, { className: "w-4c h-4c", src: this.value });
                    break;
            }
        }
        return divValue;
