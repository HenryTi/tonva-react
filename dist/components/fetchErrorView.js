...
var FetchErrorView = /** @class */ (function (_super) {
    ...
    FetchErrorView.prototype.render = function () {
        ...
        return jsx_runtime_1.jsx("div", __assign({ className: "tv-page" }, { children: jsx_runtime_1.jsx("article", { children: jsx_runtime_1.jsxs("main", __assign({ className: "va-error p-3" }, { children: [jsx_runtime_1.jsx("div", { children: "\u7F51\u7EDC\u51FA\u73B0\u95EE\u9898" }, void 0),
                        ...
                        jsx_runtime_1.jsxs("div", __assign({ style: { wordWrap: "break-word" } }, { children: ["url: ", url] }), void 0), errContent, jsx_runtime_1.jsxs("div", __assign({ className: "p-3 text-center" }, { children: [jsx_runtime_1.jsx("button", __assign({ className: "btn btn-primary mr-3", type: 'button', onClick: this.close }, { children: "\u5173\u95ED" }), void 0),
