...
var SearchBox = /** @class */ (function (_super) {
    ...
    SearchBox.prototype.render = function () {
        ...
        if (tool_1.env.isMobile === true)
            autoComplete = 'off';
        return jsx_runtime_1.jsx("form", __assign({ className: className, onSubmit: this.onSubmit, autoComplete: autoComplete }, { children: jsx_runtime_1.jsxs("div", __assign({ className: classnames_1.default("input-group", inputSize) }, { children: [label && jsx_runtime_1.jsx("div", __assign({ className: "input-group-addon align-self-center me-2" }, { children: label }), void 0), jsx_runtime_1.jsx("input", { ref: function (v) { return _this.input = v; }, onChange: this.onChange, type: "text", name: "key", onFocus: onFocus, className: classnames_1.default('form-control', inputClassName || 'border-primary'), placeholder: placeholder, defaultValue: this.props.initKey, maxLength: maxLength }, void 0), jsx_runtime_1.jsx("div", __assign({ className: "input-group-append" }, { children: jsx_runtime_1.jsxs("button", __assign({ ref: function (v) { return _this.button = v; }, className: "btn btn-primary", type: "submit", disabled: this.props.allowEmptySearch !== true }, { children: [jsx_runtime_1.jsx("i", { className: 'fa fa-search' }, void 0), jsx_runtime_1.jsx("i", { className: "fa" }, void 0), buttonText] }), void 0) }), void 0)] }), void 0) }), void 0);
    };
    return SearchBox;
}(React.Component));
