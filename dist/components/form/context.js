...
var Context = /** @class */ (function () {
    function Context(form, uiSchema, data, inNode, isRow) {
        ...
        this.renderErrors = (0, mobx_react_1.observer)(function () {
            ...
            if (errors.length === 0)
                return null;
            return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: errors.map(function (err) { return (0, jsx_runtime_1.jsxs)("span", __assign({ className: "text-danger inline-block my-1 ms-3" }, { children: [(0, jsx_runtime_1.jsx)("i", { className: "fa fa-exclamation-circle" }), " \u00A0", err] }), err); }) });
        });
