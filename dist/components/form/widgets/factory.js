...
function factory(context, itemSchema, children, fieldProps) {
    ...
    switch (type) {
        case 'arr':
            ...
            return (0, jsx_runtime_1.jsx)(arrComponent_1.ArrComponent, { parentContext: context, arrSchema: arrSchema, children: children });
        default:
            break;
    }
    var typeWidget;
    ...
    if (ui === undefined) {
        ...
        switch (widgetType) {
            ...
            case 'custom':
                ...
                break;
            case 'group':
                return (0, jsx_runtime_1.jsx)("span", { children: "impletment group" });
        }
        //label = uiLabel || name;
    }
    ...
    return (0, jsx_runtime_1.jsx)(widget.container, {});
    /*
    if (isRow === false) {
