...
var ImageWidget = /** @class */ (function (_super) {
    ...
    function ImageWidget(context, itemSchema, fieldProps, children) {
        ...
        _this.observerRender = (0, mobx_react_1.observer)(function () {
            ...
            return (0, jsx_runtime_1.jsx)("div", __assign({ className: (0, classnames_1.default)(cn), onClick: onClick }, { children: (0, jsx_runtime_1.jsx)(image_1.Image, { src: _this.imageSrc, className: "w-4c h-4c" }) }));
        });
