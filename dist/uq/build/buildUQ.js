...
function buildTuid(tuid) {
    var ts = "\t".concat((0, tools_1.entityName)(tuid.sName), ": UqTuid<Tuid").concat((0, tool_1.capitalCase)(tuid.sName), ">;");
    return ts;
}
...
function buildTag(tag) {
    var sName = tag.sName;
    var ts = "\t".concat((0, tools_1.entityName)(sName), ": UqTag;");
    return ts;
}
function buildID(id) {
    var sName = id.sName;
    var ts = "\t".concat((0, tools_1.entityName)(sName), ": UqID<any>;");
    return ts;
}
